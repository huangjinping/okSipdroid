...
public class Settings extends PreferenceActivity implements OnSharedPreferenceChangeListener, OnClickListener {
    ...
    static final String TAG = "SETING";
...
//    private final String sharedPrefsFile = "org.sipdroid.sipua_preferences";
    ...
    String mKey;
    private String sharedPrefsFile = "org.sipdroid.sipua_preferences";
    ...
    public static String getSharedPrefsFile(Context context) {
    ...
    public static String getSharedPrefsPath(Context context) {
        String packageName = context.getPackageName();
        String result = "/data/data/" + packageName + "/shared_prefs/";
        return result;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sharedPrefsFile = getSharedPrefsFile(this);
        sharedPrefsPath = getSharedPrefsPath(this);

        Log.d(TAG, "======================" + sharedPrefsPath);
